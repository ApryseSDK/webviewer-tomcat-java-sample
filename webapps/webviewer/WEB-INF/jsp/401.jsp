...
<html>
 ...
 <body>
   ...
   <p>
    For example, to add the <tt>user</tt> role to a user named
    <tt>tomcat</tt> with a password of <tt>s3cret</tt>, add the following to the
    config file listed above.
   </p>
<pre>
&lt;role rolename="user"/&gt;
&lt;user username="tomcat" password="s3cret" roles="user"/&gt;
</pre>
   <p>
    ...
    <ul>
      <li><tt>user</tt> - allows access to the HTML GUI</li>
    </ul>
   <p>
   ...
   <ul>
    <li>Users with the <tt>user</tt> role should not be granted the
